Contributing to BogCoin Core
==================================

The BogCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BogCoin Core project, and is not to be
confused with overall BogCoin Network Protocol consensus changes.

Whether a pull request is merged into BogCoin Core rests with the project merge
...
Patches that change BogCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BogCoin consensus, it must have been
...
The project leader is the release manager for each BogCoin Core release.
