The following is a list of assets used in the bogcoin source and their proper attribution.
...
* License: MIT
* Site: [https://bogcointalk.org/index.php?topic=15276.0](https://bogcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original bogcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/bogcoin.icns, src/qt/res/src/bogcoin.svg,
	src/qt/res/src/bogcoin.ico, src/qt/res/src/bogcoin.png,
	src/qt/res/src/bogcoin_testnet.png, docs/bogcoin_logo_doxygen.png,
