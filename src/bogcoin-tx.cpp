...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BogCoin Core bogcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bogcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bogcoin transaction") + "\n" +
                               "  bogcoin-tx [options] -create [commands]   " + _("Create hex-encoded bogcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bogcoin transaction
