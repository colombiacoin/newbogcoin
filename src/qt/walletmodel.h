...
#ifndef BOGCOIN_QT_WALLETMODEL_H
#define BOGCOIN_QT_WALLETMODEL_H
...
/** Interface to Bogcoin wallet from Qt view code. */
...
public:
    ...
    bool isMine(CBogcoinAddress address);
...
#endif // BOGCOIN_QT_WALLETMODEL_H
