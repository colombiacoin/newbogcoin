...
#ifndef BOGCOIN_QT_RPCCONSOLE_H
#define BOGCOIN_QT_RPCCONSOLE_H
...
public slots:
    ...
    void showRepair();
    /** Open external (default) editor with bogcoin.conf */
    void showConfEditor();
