...
#ifndef BOGCOIN_QT_BOGCOINUNITS_H
#define BOGCOIN_QT_BOGCOINUNITS_H
...
/** BOG unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BogcoinUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BogcoinUnits(QObject* parent);

    /** BOG units.
      @note Source: https://en.bogcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        BOG,
        mBOG,
...
typedef BogcoinUnits::Unit BogcoinUnit;

#endif // BOGCOIN_QT_BOGCOINUNITS_H
