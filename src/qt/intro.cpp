...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        intro.setWindowIcon(QIcon(":icons/bogcoin"));
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BogCoin Core"),
     ...
     * override -datadir in the bogcoin.conf file in the default data directory
     * (to be consistent with bogcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
