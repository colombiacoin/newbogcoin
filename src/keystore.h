...
#ifndef BOGCOIN_KEYSTORE_H
#define BOGCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/bogcoin/bips/blob/master/bip-0013.mediawiki
