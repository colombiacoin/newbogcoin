...
#ifndef BOGCOIN_WALLET_H
#define BOGCOIN_WALLET_H
...
public:
    ...
    std::map<CBogcoinAddress, std::vector<COutput> > AvailableCoinsByAddress(bool fConfirmed = true, CAmount maxCoinValue = 0);
