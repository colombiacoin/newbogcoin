...
###   This script attempts to download the signature file SHA256SUMS.asc from bogcoin.org
...
WORKINGDIR="/tmp/bogcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://bogcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://bogcoin.org/bin/"
VERSIONPREFIX="bogcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'bogcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[bogcoin-]<version>-[rc[0-9]] (example: bogcoin-0.9.2-rc1)"
   echo "wget output:"
